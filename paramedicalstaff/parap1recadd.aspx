<%@ Page Title="::Paramedical Hospital Add::" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="parap1recadd.aspx.cs" Inherits="NewWebApp.paramedicalstaff.parap1recadd" %>
    ...
    <table class="table table-responsive-sm" style="font-weight: normal; width: 100%; color: #003366;
        ...
        <tr>
            <td style="font-weight: bold; width: 100%;
                ...
                &nbsp;Add Edit Paramedical Staff(P1) Records<asp:Label ID="Fnamet" runat="server" Visible="False"></asp:Label>
                <asp:Label ID="Uidt" runat="server" Visible="False"></asp:Label></td>
        </tr>
        <tr>
            <td style="width: 100%; font-size: 12px; text-align: left;">
                <asp:Table class=" table table-responsive-sm" ID="Table1" runat="server" CellPadding="0" CellSpacing="0" Font-Size="Small" Width="100%">
                </asp:Table>
            </td>
        </tr>
        <tr>
            <td style="width: 100%; font-size: 13px; text-align: left;">
                <asp:Table class=" table table-responsive-sm" ID="Table2" runat="server" CellPadding="0" CellSpacing="0" Width="100%">
                </asp:Table>
                </td>
        </tr>
        <tr>
