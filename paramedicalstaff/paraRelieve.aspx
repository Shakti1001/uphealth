<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="paraRelieve.aspx.cs" Inherits="NewWebApp.paramedicalstaff.paraRelieve" %>
    ...
    <table class="table table-responsive-sm" style="font-weight: bold; width: 100%;
        ...
        <tr>
            <td colspan="2" style="font-size: 12pt; width: 100%; height: 24px; background-color: burlywood;
                text-align: center">
                GPF No:<asp:Label ID="sen" runat="server" ForeColor="Blue"></asp:Label>,Name:<asp:Label ID="name" runat="server"
        ...
        <tr>
            ...
            <asp:DropDownList ID="DD1" runat="server">
                        ...
                        <tr>
                            <td align="left" style="width: 25%; background-color: #fff8dc; text-align: left; height: 25px;">
                    ...
                    <asp:Button class="btn btn-success" ID="BSAVE" runat="server" Text="Save" OnClick="BSAVE_Click" Width="80px" /></td>
                            <td align="left" style="width: 25%; background-color: #fff8dc; text-align: left; height: 25px;">
                    <asp:Button class="btn btn-default" ID="PFsheet" runat="server" OnClick="PFsheet_Click" Text="Print Relieving Order" Width="144px" /></td>
                        </tr>
                        <tr>
...
PostBackUrl='<%#"~/Proforma2/RelOrdprint.aspx?statussr=" + Eval("statussr")%>' Text="Print"></asp:LinkButton>
