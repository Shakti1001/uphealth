<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="parap2opr.aspx.cs" Inherits="NewWebApp.paramedicalstaff.parap2opr" %>
            ...
            <table class="table table-responsive-sm table-active" style=" width: 100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="width: 100%;  text-align: right;" valign="top">
                        ...
                        <td><asp:LinkButton ID="LinkButton1" class="btn btn-danger" OnClick="LinkButton1_Click" runat="server"><span class="glyphicon glyphicon-backward"></span>Back</asp:LinkButton></td>
                ...
                <tr>
                    <td style="width: 100%;  text-align: center" valign="top">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 100%">
                                                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                                                                ...
                                                                                SelectCommand="SELECT PMDpersonaldetails.idno, PMDpersonaldetails.gpfno, PMDpersonaldetails.name, PMDpersonaldetails.fathername, CONVERT (Char, PMDpersonaldetails.dob, 106) AS dob, hospitaldistrict.districtname, PMDCadre.cadrename, PMDCposted.sno, PMDCposted.poposting FROM PMDpersonaldetails INNER JOIN hospitaldistrict ON PMDpersonaldetails.homedistrictid = hospitaldistrict.districtid INNER JOIN PMDCadre ON PMDpersonaldetails.cadreid = PMDCadre.cadreid INNER JOIN PMDCposted ON PMDpersonaldetails.idno = PMDCposted.idno WHERE  PMDCposted.poposting in ( select  sno from hospitalname where ddoid=@userid) AND (PMDpersonaldetails.name LIKE  @name) ORDER BY PMDpersonaldetails.name">
                                                                                <SelectParameters>
                        ...
                        <asp:TextBox ID="VALT" runat="server" Width="64px" AutoPostBack="True" OnTextChanged="VALT_TextChanged" Visible="False"></asp:TextBox></td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" Height="50%" Width="100%">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="VALT" Name="name" PropertyName="Text" />
                            ...
                            <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" Height="50%" Width="100%">
 ...
 <asp:TemplateField HeaderText="Computer ID" SortExpression="idno">
               ...
               <%-- <asp:TemplateField HeaderText="GPF No" SortExpression="gpfno">
                ...
                <asp:BoundField DataField="districtname" HeaderText="Home District" SortExpression="districtname" />
                            ...
                            <asp:GridView ID="GridView3" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" Height="50%" Width="100%">
            <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
            <SelectedRowStyle BackColor="#FFCC66" ForeColor="Navy" Font-Bold="True" />
            <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
            <HeaderStyle BackColor="BurlyWood" Font-Bold="True" ForeColor="Maroon" />
...
<HeaderStyle HorizontalAlign="Left" />
 ...
 <asp:TemplateField HeaderText="Computer ID" SortExpression="idno">
                ...
                <asp:BoundField DataField="districtname" HeaderText="Home District" SortExpression="districtname" />
                            ...
                            <asp:GridView ID="GridView4" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" Height="50%" Width="100%">
            <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
            <SelectedRowStyle BackColor="#FFCC66" ForeColor="Navy" Font-Bold="True" />
            <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
            <HeaderStyle BackColor="BurlyWood" Font-Bold="True" ForeColor="Maroon" />
