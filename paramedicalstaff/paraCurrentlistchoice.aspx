<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="paraCurrentlistchoice.aspx.cs" Inherits="NewWebApp.paramedicalstaff.paraCurrentlistchoice" %>
                                            ...
                                            <tr>
                                                <td style="width: 100%; background-color: #e8cd76">
                                                    <table class="table table-responsive-sm" border="0" cellpadding="0" cellspacing="0" style="font-weight: bold; width: 100%;
                                                        ...
                                                        <tr>
                                                            <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                                                <asp:DropDownList ID="fcadre" runat="server" OnSelectedIndexChanged="Dpost_SelectedIndexChanged"
                                                        ...
                                                        <tr>
                                                            <td align="left" style="width: 100%; color: black; text-align: center; height: 24px;" colspan="4">
