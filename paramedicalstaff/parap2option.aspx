<%@ Page Title="::Paramedical Personal Section::" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="parap2option.aspx.cs" Inherits="NewWebApp.paramedicalstaff.parap2option" %>
                ...
                <tr>
                    <td colspan="2" style="width: 100%; text-align: center" valign="top">
                        ...
                        <asp:LinkButton ID="Addpers" runat="server" Font-Bold="True" Font-Size="Medium"
                            OnClick="Addpers_Click" Width="200px" ForeColor="#74211F">Add Personnel Details</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                        <asp:LinkButton ID="Editpers" runat="server" Font-Bold="True" OnClick="Editpers_Click" Font-Size="Medium" Width="200px" ForeColor="#74211F">Edit Personnel Details</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                    ...
                    <asp:LinkButton ID="EditQ" runat="server" Font-Bold="True" ForeColor="#74211F"
                        OnClick="EditQ_Click" Width="200px">Add/Edit Qualification  Details</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                        <asp:LinkButton ID="EditPost" runat="server" Font-Bold="True" OnClick="EditPost_Click" Font-Size="Medium" 
                                                                Width="200px" ForeColor="#74211F" style="height: 19px">Add/Edit Posting Details</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                        ...
                        OnClick="EditEQN_Click" Width="320px" ForeColor="#74211F">Add/Edit Departmental Enquiry/ Proceedings</asp:LinkButton></td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                                                            <asp:LinkButton ID="JANDR" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#74211F"
                                                                OnClick="JANDR_Click" Width="200px" style="height: 19px"> Join And Relieve</asp:LinkButton></td>
                                                    </tr>
                    ...
                    <asp:LinkButton  ID="Rsec" runat="server" Font-Bold="True" Font-Size="Medium" OnClick="Rsec_Click"
                        Width="200px" ForeColor="#74211F">Reports</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10">
                                                        </td>
