<%@ Page Title="::Paramedical Home Page::" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="parahome.aspx.cs" Inherits="NewWebApp.paramedicalstaff.parahome" %>
                ...
                <tr>
                    <td colspan="2" style="width: 100%; text-align: center" valign="top">
                                                ...
                                                <table class="table table-responsive-sm" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td bgcolor="#fe8631" class="normalEng" height="34" style="font-weight: bold; color: #ffff99;
                                                            ...
                                                            &nbsp;Welcome To Paramedical Section&nbsp;</td>
                        ...
                        <asp:LinkButton ID="Hsec" runat="server" Font-Bold="True" Font-Size="Medium"
                            OnClick="Hsec_Click" Width="176px" ForeColor="#74211F">Hospital Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10">
                                                        </td>
                        ...
                        <asp:LinkButton ID="Msec" runat="server" Font-Bold="True" OnClick="Msec_Click" Font-Size="Medium" Width="176px" ForeColor="#74211F">Personnel Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                    <asp:LinkButton ID="Psec" runat="server" Font-Bold="True" ForeColor="#74211F"
                        OnClick="Psec_Click" Width="168px">Payrole Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10">
                                                        </td>
