<%@ Page Title="::Paramedical Join/Relieve::" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="parap2JRmenu.aspx.cs" Inherits="NewWebApp.paramedicalstaff.parap2JRmenu" %>
            ...
            <table class="table table-responsive-sm table-active" style="width: 100%">
                ...
                <tr>
                    <td colspan="2" style="width: 100%; text-align: center" valign="top">
                                                ...
                                                <table class="table table-responsive-sm" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td bgcolor="#fe8631" class="normalEng" height="34" style="font-weight: bold; color: #ffff99;
                                                            ...
                                                            &nbsp; Paramedical Section / Join And Relieve Option
                        ...
                        <asp:LinkButton ID="joinlink" runat="server" Font-Bold="True" OnClick="joinlink_Click" ForeColor="#74211F">Joining Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                        <asp:LinkButton ID="rellink" runat="server" Font-Bold="True" OnClick="rellink_Click" ForeColor="#74211F">Relieve Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                    <asp:LinkButton ID="RetLink" runat="server" Font-Bold="True" OnClick="RetLink_Click" ForeColor="#74211F">Retierment Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                        <asp:LinkButton ID="EJLink" runat="server" Font-Bold="True" OnClick="EJLink_Click" ForeColor="#74211F">Edit Joining Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                    <asp:LinkButton ID="ERLink" runat="server" Font-Bold="True" OnClick="ERLink_Click" ForeColor="#74211F">Edit Relieve Section</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10">
                                                        </td>
