<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paraCurrentlistprint.aspx.cs" Inherits="NewWebApp.paramedicalstaff.paraCurrentlistprint" %>
    ...
    <div>
        <div style="text-align: center">
            ...
            <table style="font-weight: normal; left: -6px; width: 800px; font-family: Arial; position: relative;
                ...
                <tr>
                    <td colspan="4" 
                        style=" width: 896px; color: #000000; background-color: #cccccc; text-align: center; font-weight: bold; font-size: 14px; height: 24px;" 
                        align="center">
                ...
                <tr>
                    <td colspan="4" style="font-weight: bold; font-size: 14px; width: 896px; color: #000000;
                        background-color: #cccccc; text-align: center" align="center">
                        <asp:Label ID="strq" runat="server" Font-Bold="True" ForeColor="#C00000">Sorry,No Record Found</asp:Label></td>
                </tr>
                <tr>
                    <td colspan="4" 
                        style="font-size: 16px; width: 100%; color: #000000; text-align: right; height: 3px;" 
                        align="center">
                        </td>
                </tr> 
                <tr>
                    <td colspan="4" 
                        style="font-size: 13px; width: 100%; color: #000000; text-align: center; height: 3px;" 
                        align="center">
                ...
                <tr>
                    <td style="width: 36px; height: 20px;" align="center">
                    </td>
                    <td style="width: 320px; text-align: left; height: 20px;" align="center">
                        <asp:Label ID="distsublbl" runat="server" Visible="False"></asp:Label></td>
                    <td style="width: 420px; height: 20px;" align="center">
                    </td>
