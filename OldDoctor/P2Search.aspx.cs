...
namespace NewWebApp.OldDoctor
{
    public partial class P2Search : System.Web.UI.Page
    {
        ...
        public void runqualC()
        {
            ...
            { q5 = "DisId=" + district.SelectedItem.Value + ""; }
            else { q5 = "DisId like '%'"; }



            qr1 = " And " + q1 + " And " + q2 + " And " + q5 + " ";//And " + q9 + "

            qr2 = q2 + " And " + q5 + " and " + q1 + " ";//
            ...
            if (i == true)
            {
                ...
                c.gv(GridView1, "select idno,name,fathername,districtname,Convert(varchar(11),dob,106) as dob,senno from OLD_CURRENTSEARCHCRITARIA where (divid LIKE '" + Divs.Text + "')" + qr1 + "");

            }
            else
            {
                c.gv(GridView1, "select idno,name,fathername,districtname,Convert(varchar(11),dob,106) as dob,senno from OLD_CURRENTSEARCHCRITARIA WHERE  ( " + qr2 + " )");
