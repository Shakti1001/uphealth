<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/Site1.Master" AutoEventWireup="true" CodeBehind="Proformachoice.aspx.cs" Inherits="NewWebApp.Guest.Proformachoice" %>
...
<div class="container" style="text-align: center">
            ...
            <table class="table table-responsive-sm table-active" style=" width: 100%; table-layout:fixed;">
                <tr>
                    <td style="width: 100%; text-align: right; height: 4px;" valign="top" colspan="2">
                        <asp:LinkButton ID="LinkButton1" class="btn btn-danger" OnClick="Back_Click" runat="server"><span class="glyphicon glyphicon-backward"></span>Back</asp:LinkButton>  </td>
                </tr>
                <tr>
        ...
        <asp:Label ID="count" runat="server" Visible="False"></asp:Label><asp:Label
            ID="Divs" runat="server" Visible="False">%</asp:Label><asp:Label ID="Uidt" runat="server" Visible="False"></asp:Label><asp:Label ID="Ename" runat="server" Visible="False"></asp:Label></td>
                    ...
                    Seniority No.</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:TextBox ID="Sen" class="form-control" runat="server" AutoPostBack="True" OnTextChanged="Sen_TextChanged"></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                            <tr>
                    ...
                    Designation</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:DropDownList ID="DDesign" class="form-control" runat="server" Width="90%" AutoPostBack="True" OnSelectedIndexChanged="DDesign_SelectedIndexChanged">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    Level</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:DropDownList ID="Dlevel" class="form-control" runat="server" Width="90%" AutoPostBack="True" OnSelectedIndexChanged="Dlevel_SelectedIndexChanged">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
