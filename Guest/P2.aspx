<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="P2.aspx.cs" Inherits="NewWebApp.Guest.P2" %>
...
<body>
    ...
    <div >
            ...
            <table style="font-weight: normal; left: -6px; width: 90%; font-family: Arial; position: relative; top: 0px; height: 88px; border-right: #000033 thin solid; border-top: #000033 thin solid; border-left: #000033 thin solid; border-bottom: #000033 thin solid; color: #330000;" cellpadding="0" cellspacing="0">
               <tr>
                ...
                <tr>
                    ...
                    <td style="width: 320px; text-align: left">
                        Mobile No.</td>
                    <td style="text-align: left" colspan="2">
                        :<asp:Label ID="MOBILE" runat="server" Width="90%" 
