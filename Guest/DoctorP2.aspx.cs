...
namespace NewWebApp.Guest
{
    ...
    public void data()
    {
        ...
        con.Open();
         SqlCommand com6 = new SqlCommand("SELECT personaldetails.senno, personaldetails.name, personaldetails.fathername, personaldetails.sex, cadre.cadrename, personaldetails.cadresenno, category.category, subcategory.scategory, hospitaldistrict.districtname, CONVERT(char, personaldetails.dob, 106) AS dob, CONVERT(char,personaldetails.doapp, 106) AS doapp, CONVERT(char, personaldetails.dojoining, 106) AS dojoining, CONVERT(char,personaldetails.doconfirmation, 106) AS doconfirmation, personaldetails.coupleid,  personaldetails.laddress, personaldetails.paddress,dbo.personaldetails.lavel,personaldetails.remark,fcadre.fcadrename FROM  personaldetails INNER JOIN  category ON personaldetails.catid = category.catid INNER JOIN cadre ON personaldetails.cadre = cadre.cadreid INNER JOIN  hospitaldistrict ON personaldetails.homedistrictid = hospitaldistrict.districtid INNER JOIN subcategory ON personaldetails.scatid = subcategory.scatid INNER JOIN fcadre ON personaldetails.fcadre = fcadre.fcadreid where personaldetails.idno = '" + Request.QueryString["idno"] + "'  ", con); // table name 
        ...
        {
            if (!(ds6.Tables[0].Rows[0][0].ToString().Equals(System.DBNull.Value)))
            {
                Sen.Text = ds6.Tables[0].Rows[0][0].ToString();
            ...
            if (!(ds6.Tables[0].Rows[0][1].ToString().Equals(System.DBNull.Value)))
            {
                Name.Text = ds6.Tables[0].Rows[0][1].ToString();
            ...
            if (!(ds6.Tables[0].Rows[0][2].ToString().Equals(System.DBNull.Value)))
            {
                FNAME.Text = ds6.Tables[0].Rows[0][2].ToString();
            }
            else
            {
                FNAME.Text = "N.A";
            ...
            if (!(ds6.Tables[0].Rows[0][3].ToString().Equals(System.DBNull.Value)))
            {
                SEX.Text = ds6.Tables[0].Rows[0][3].ToString();
                if (SEX.Text == "1")
                    SEX.Text = "Female";
                else
                    SEX.Text = "Male";
            ...
            if (!(ds6.Tables[0].Rows[0][4].ToString().Equals(System.DBNull.Value)))
            {
                CADRE.Text = ds6.Tables[0].Rows[0][4].ToString();
            }
            else
            {
                CADRE.Text = "N.A";
            ...
            if (!(ds6.Tables[0].Rows[0][5].ToString().Equals(System.DBNull.Value)))
            {
                CSN.Text = ds6.Tables[0].Rows[0][5].ToString();
            ...
            if (!(ds6.Tables[0].Rows[0][6].ToString().Equals(System.DBNull.Value)))
            {
                CATEGORY.Text = ds6.Tables[0].Rows[0][6].ToString();
            }
            else
            {
                CATEGORY.Text = "N.A";
            ...
            if (!(ds6.Tables[0].Rows[0][7].ToString().Equals(System.DBNull.Value)))
            {
                SCATEGORY.Text = ds6.Tables[0].Rows[0][7].ToString();
            }
            else
            {
                SCATEGORY.Text = "N.A";
            }
            if (!(ds6.Tables[0].Rows[0][8].ToString().Equals(System.DBNull.Value)))
            {
                if (ds6.Tables[0].Rows[0][8].ToString() == "NONE")
                {
                    try
                    {
                         SqlCommand com7 = new SqlCommand("SELECT     hname FROM         otherhomedistrict where idno = '" + Request.QueryString["idno"] + "'or senno='" + Sen.Text + "' ", con);
            SqlDataAdapter da7 = new SqlDataAdapter(com7);
            DataSet ds7 = new DataSet();
            da7.Fill(ds7);

                       
                        if (!(ds7.Tables[0].Rows[0][0].ToString().Equals(System.DBNull.Value)))
                        {
                            HDIST.Text = ds7.Tables[0].Rows[0][0].ToString();
                        }
                        else
                        {
                ...
                {
                    HDIST.Text = ds6.Tables[0].Rows[0][8].ToString();
                }
            ...
            if (!(ds6.Tables[0].Rows[0][9].ToString().Equals(System.DBNull.Value)))
            {
                DOB.Text =ds6.Tables[0].Rows[0][9].ToString();
            }
            else
            {
                DOB.Text = "N.A";
            ...
            if (!(ds6.Tables[0].Rows[0][10].ToString().Equals(System.DBNull.Value)))
            {
                DOA.Text = ds6.Tables[0].Rows[0][10].ToString();
            }
            ...
            if (!(ds6.Tables[0].Rows[0][11].ToString().Equals(System.DBNull.Value)))
            {
                DOJ.Text = ds6.Tables[0].Rows[0][11].ToString();
            }
            else
            {
                DOJ.Text = "N.A";
            ...
            if (!(ds6.Tables[0].Rows[0][12].ToString().Equals(System.DBNull.Value)))
            {
                DOC.Text = ds6.Tables[0].Rows[0][12].ToString();
            }
            else
            {
                DOC.Text = "N.A";
            }
            if (!(ds6.Tables[0].Rows[0][13].ToString().Equals(System.DBNull.Value)))
            {

                CUID.Text = ds6.Tables[0].Rows[0][13].ToString();
                if (CUID.Text == "99")
                {
            ...
            if (!(ds6.Tables[0].Rows[0][14].ToString().Equals(System.DBNull.Value)))
            {
                LA.Text = ds6.Tables[0].Rows[0][14].ToString();
            }
            else
            {
                LA.Text = "N.A";
            }
            if (!(ds6.Tables[0].Rows[0][15].ToString().Equals(System.DBNull.Value)))
            {
                PA.Text = ds6.Tables[0].Rows[0][15].ToString();
            }
            else
            {
                PA.Text = "N.A";
            }
            if (!(ds6.Tables[0].Rows[0][16].ToString().Equals(System.DBNull.Value)))
            {
                Llavel.Text = ds6.Tables[0].Rows[0][16].ToString();
            }
            else
            {
                Llavel.Text = "";
            ...
            if (!(ds6.Tables[0].Rows[0][17].ToString().Equals(System.DBNull.Value)))
            {
                Remark.Text = ds6.Tables[0].Rows[0][17].ToString();
            }
            else
            {
                Remark.Text = "";
            }
            if (!(ds6.Tables[0].Rows[0][18].ToString().Equals(System.DBNull.Value)))
            {
                Label3.Text = ds6.Tables[0].Rows[0][18].ToString();
            }
            else
            {
                Label3.Text = "";
   ...
   public void runtable()
    {//SELECT     postingdetails.sno, designation.designame, post.newpostname, hospitaldistrict.districtname, hospitalname.hname, CONVERT(char, postingdetails.doposting, 106) AS doposting, CONVERT(char, postingdetails.dorelieve, 106) AS dorelieve, postingdetails.doposting AS pd, postingdetails.dorelieve AS pr FROM         postingdetails INNER JOIN  hospitaldistrict ON postingdetails.districtid = hospitaldistrict.districtid INNER JOIN  designation ON postingdetails.Desigid = designation.Desigid INNER JOIN  post ON postingdetails.postid = post.newpostid LEFT OUTER JOIN   hospitalname ON postingdetails.poposting = hospitalname.sno WHERE     (postingdetails.idno = '" + Request.QueryString["idno"] + "') ORDER BY postingdetails.doposting
        ...
        try
        {//
            SqlCommand com7 = new SqlCommand("SELECT     designation.designame, post.newpostname, hospitaldistrict.districtname, hospitalname.hname, CONVERT(char, postingdetails.doposting, 103) AS doposting, CONVERT(char, postingdetails.dorelieve, 103) AS dorelieve,hospitalname.sno, postingdetails.doposting AS pd, postingdetails.dorelieve AS pr,postingdetails.districtid, postingdetails.poposting, postingdetails.sno AS ppid FROM  postingdetails INNER JOIN hospitaldistrict ON postingdetails.districtid = hospitaldistrict.districtid INNER JOIN designation ON postingdetails.Desigid = designation.Desigid INNER JOIN post ON postingdetails.postid = post.newpostid LEFT OUTER JOIN  hospitalname ON postingdetails.poposting = hospitalname.sno WHERE     (postingdetails.idno = '" + Request.QueryString["idno"] + "') ORDER BY postingdetails.doposting", con);
            SqlDataAdapter da7 = new SqlDataAdapter(com7);
            DataSet ds7 = new DataSet();
            da7.Fill(ds7);
            ...
            if (ds7.Tables[0].Rows.Count > 0)
            {
                ...
                Table1.Rows.Add(rw);
                for (j = 0; j <= ds7.Tables[0].Rows.Count - 1; j++)
                {
                    ...
                    if (!(ds7.Tables[0].Rows[j][0].ToString().Equals(System.DBNull.Value)))
                    {
                        tcell11.Text = ds7.Tables[0].Rows[j][0].ToString();//desig
                    }
                    else
                    {
                        tcell11.Text = "NONE";
                    ...
                    if (!(ds7.Tables[0].Rows[j][1].ToString().Equals(System.DBNull.Value)))
                    {
                        tcell21.Text = ds7.Tables[0].Rows[j][1].ToString();//post
                    }
                    else
                    {
                        tcell21.Text = "NONE";
                    ...
                    if (!(ds7.Tables[0].Rows[j][2].ToString().Equals(System.DBNull.Value)))
                    {
                        tcell31.Text = ds7.Tables[0].Rows[j][2].ToString();//district
                    }
                    else
                    {
                        tcell31.Text = "NONE";
                    ...
                    if (!(ds7.Tables[0].Rows[j][3].ToString().Equals(System.DBNull.Value)))//hname
                    {
                        tcell41.Text = ds7.Tables[0].Rows[j][3].ToString();
                        ////tcell41.Text = "NONE";
                        ...
                        if (ds7.Tables[0].Rows[j][9].ToString() == "0" && ds7.Tables[0].Rows[j][10].ToString() == "0")
                        {
                            string a = ds7.Tables[0].Rows[j][7].ToString();
                            string b = ds7.Tables[0].Rows[j][11].ToString();
                            ...
                            try
                            {
                                ...
                                //DateTime x= DateTime.ParseExact(a, "MM/dd/yyyy hh:mm:ss", en. DateTimeStyles.NoCurrentDateDefault); 
                                 SqlCommand com2 = new SqlCommand("SELECT postingdetails.sno, otherhospitalposting.hname, postingdetails.idno,postingdetails.doposting FROM  postingdetails INNER JOIN  otherhospitalposting ON postingdetails.sno = otherhospitalposting.sno WHERE     (postingdetails.sno= '" + Convert.ToInt32(b) + "')AND (postingdetails.idno = " + Request.QueryString["idno"] + ")", con);
            ...
            da2.Fill(ds2);
                                ...
                                {
                                    tcell41.Text = ds2.Tables[0].Rows[0][1].ToString();
                                }
                                else
                                {
                                    tcell41.Text = "NONE";
                    ...
                    tcell51.Text = ds7.Tables[0].Rows[j][4].ToString();//dp
                    ...
                    tcell61.Text = ds7.Tables[0].Rows[j][5].ToString();//dr
    ...
    {
       SqlCommand com2 = new SqlCommand("SELECT postingdetails.sno, otherhospitalposting.hname, postingdetails.idno,postingdetails.doposting FROM  postingdetails INNER JOIN  otherhospitalposting ON postingdetails.sno = otherhospitalposting.sno WHERE (postingdetails.idno = " + Request.QueryString["idno"] + ")", con);
            SqlDataAdapter da2 = new SqlDataAdapter(com2);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
        int j;
        if (ds2.Tables[0].Rows.Count > 0)
        {
            ...
            for (j = 0; j <= ds2.Tables[0].Rows.Count - 1; j++)
            {
                ...
                tcell11.BorderColor = System.Drawing.Color.SlateGray;
                tcell11.ForeColor = System.Drawing.Color.Black;
                tcell11.Text = ds2.Tables[0].Rows[j][0].ToString();
                rw1.Cells.Add(tcell11);

                TableCell tcell21 = new TableCell();
                tcell21.Text = ds2.Tables[0].Rows[j][1].ToString();
                tcell21.BorderWidth = 1;
                tcell21.BorderColor = System.Drawing.Color.SlateGray;
                tcell21.ForeColor = System.Drawing.Color.Black;
                rw1.Cells.Add(tcell21);
                ...
                TableCell tcell31 = new TableCell();
                tcell31.Text = ds2.Tables[0].Rows[j][2].ToString();
                tcell31.BorderWidth = 1;
                tcell31.BorderColor = System.Drawing.Color.SlateGray;
                tcell31.ForeColor = System.Drawing.Color.Black;
                rw1.Cells.Add(tcell31);
                ...
                TableCell tcell41 = new TableCell();
                tcell41.Text = ds2.Tables[0].Rows[j][3].ToString();
                tcell41.BorderWidth = 1;
                tcell41.BorderColor = System.Drawing.Color.SlateGray;
                tcell41.ForeColor = System.Drawing.Color.Black;
                rw1.Cells.Add(tcell41);
                ...
                TableCell tcell51 = new TableCell();
                tcell51.Text = ds2.Tables[0].Rows[j][4].ToString();
                tcell51.BorderWidth = 1;
                tcell51.BorderColor = System.Drawing.Color.SlateGray;
                tcell51.ForeColor = System.Drawing.Color.Black;
                rw1.Cells.Add(tcell51);
                ...
                TableCell tcell61 = new TableCell();
                tcell61.Text = ds2.Tables[0].Rows[j][5].ToString();
                tcell61.BorderWidth = 1;
                tcell61.BorderColor = System.Drawing.Color.SlateGray;
                tcell61.ForeColor = System.Drawing.Color.Black;
                rw1.Cells.Add(tcell61);
    ...
    public void study()
    {
        ...
        try
        {//
             SqlCommand com2 = new SqlCommand("SELECT Qualification.QuaName +'(' + specialization.spname + ')' AS st FROM qual_det INNER JOIN  Qualification ON qual_det.qid = Qualification.QuaId INNER JOIN  specialization ON qual_det.sid = specialization.spid where qual_det.idno ='" + Request.QueryString["idno"] + "'", con);
            SqlDataAdapter da2 = new SqlDataAdapter(com2);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
            ...
            if (ds2.Tables[0].Rows.Count > 0)
            {
                ...
                for (j = 0; j <= ds2.Tables[0].Rows.Count - 1; j++)
                {
                    if (j == 0)
                    {
                        QD.Text = ds2.Tables[0].Rows[j][0].ToString();
                    }
                    else
                    {
                        QD.Text = QD.Text + "," + ds2.Tables[0].Rows[j][0].ToString();
                    }
                }
            }
        }
    ...
    public void enq()
    {
        try
        {
            SqlCommand com2 = new SqlCommand("SELECT '(' + enqtype +','+ enqstatus + ')' as st FROM  Enquiry where idno ='" + Request.QueryString["idno"] + "'", con);
            SqlDataAdapter da2 = new SqlDataAdapter(com2);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
           
            if (ds2.Tables[0].Rows.Count > 0)//enqtype + enqstatus
            {
                int j;
                for (j = 0; j <= ds2.Tables[0].Rows.Count - 1; j++)
                {
                    if (j == 0)
                    {
                        Enq.Text = ds2.Tables[0].Rows[j][0].ToString();
                    }
                    else
                    {
                        Enq.Text = Enq.Text + "," + ds2.Tables[0].Rows[j][0].ToString();
                    }
    ...
    public void runqual()
    {
        ...
        {
            int j;
            SqlCommand com2 = new SqlCommand("SELECT Designation.name, lavel.levelcode, hospitaldistrict.districtname, hospitalname.hname, CONVERT(varchar,Hpostingdetails.doposting,103) as doposting ,CONVERT(varchar,Hpostingdetails.dorelieve,103) as dorelieve FROM         Hpostingdetails INNER JOIN   hospitaldistrict ON Hpostingdetails.districtid = hospitaldistrict.districtid INNER JOIN    hospitalname ON Hpostingdetails.poposting = hospitalname.sno INNER JOIN    Designation ON Hpostingdetails.postid = Designation.Dcode INNER JOIN   lavel ON Hpostingdetails.leval = lavel.levelid WHERE postingdetails.idno ='" + Request.QueryString["idno"] + "' ORDER BY CONVERT(char, Hpostingdetails.doposting, 106)", con);
            SqlDataAdapter da2 = new SqlDataAdapter(com2);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
    ...
    public void training()
    {
        try
        {
             SqlCommand com2 = new SqlCommand("SELECT  trainingdetail.trid, trainingid.trname, trainingdetail.trplace,trainingdetail.fromdate,trainingdetail.todate   FROM trainingdetail INNER JOIN trainingid ON trainingdetail.trid = trainingid.trid  WHERE trainingdetail.idno ='" + Request.QueryString["idno"] + "'", con);
            SqlDataAdapter da2 = new SqlDataAdapter(com2);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
