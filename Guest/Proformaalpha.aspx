<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/Site1.Master" AutoEventWireup="true" CodeBehind="Proformaalpha.aspx.cs" Inherits="NewWebApp.Guest.Proformaalpha" %>
 ...
 <table style="width: 100%">
        <tr>
            <td colspan="2" style="width: 100%; height: 4px; text-align: right" valign="top">
                <asp:ImageButton ID="Back" runat="server" Height="24px" ImageUrl="~/GifImages/BackArrow.gif"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td bgcolor="#fe8631" class="normalEng" height="34" style="font-weight: bold; color: #ffff99;
                                        ...
                                        Medical Section / P2 / Factsheet Search (Click On First Letter Of Name)
                                            ...
                                            <tr>
                                                <td style="width: 100%">
                                                    ...
                                                    <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click" 
                                                        style="color: #800000">All</asp:LinkButton>
                                                    </strong></td>
                                            </tr>
                                            <tr>
