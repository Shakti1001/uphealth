<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payslip.aspx.cs" Inherits="NewWebApp.Guest.payslip" %>
...
<body>
    ...
    <div class="container">
        <table class="table table-responsive-sm table-active" style="width:99% ">
        <tr>
        <td colspan="1" style="text-align: right; width: 20%;" rowspan="14">
                <a id="A1" href=" " runat="server" onclick="javascript:window.print()">Print</a>
                    </td>
                    <td></td>
                    <td></td>
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center; height: 21px;">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Maroon" Visible="False"></asp:Label></td>
                <td colspan="1" style="text-align: right; width: 20%;" rowspan="14">
                </td>
            </tr>
            <tr>
                <td colspan="4" style="text-align: center; font-weight: bold; color: black; height: 84px;" rowspan="3">
                    ...
                    <span id="sp" runat="server" style="height:52px; text-align:center">
                        <asp:Image ID="Image6" runat="server" ImageAlign="Left" ImageUrl="~/GifImages/logo.jpg" Height="69px" Width="59px" />Department of Health & Family Welfare 
                        <br />
            ...
            <tr>
                <td colspan="4" style="height: 6px">
                    <asp:Image ID="Image4" runat="server" Height="4px" ImageUrl="~/GifImages/myline1.jpg" Width="588px" /></td>
            </tr>
            <tr>
                <td colspan="4">
                 <asp:Table class="table table-responsive-sm" ID="Table2" runat="server" BorderColor="#000000" BorderWidth="0px" CellPadding="0"
            ...
            <tr>
                <td colspan="4" style="height: 6px">
                    <asp:Image ID="Image1" runat="server" Height="4px" ImageUrl="~/GifImages/myline1.jpg" Width="588px" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4">
                    <asp:Image ID="Image2" runat="server" Height="4px" ImageUrl="~/GifImages/myline1.jpg" Width="588px" /></td>
            </tr>
            <tr>
                <td colspan="4">
                               <asp:Table class="table table-responsive-sm" ID="Table1" runat="server" BorderColor="#000000" BorderWidth="0px" CellPadding="0"
                                    CellSpacing="0" Font-Bold="True" Font-Size="small" HorizontalAlign="Left" Style="font-weight: bold;
                                    font-family: Verdana; background-color: white; border-top-width: thin; border-left-width: thin; border-left-color: black; border-bottom-width: thin; border-bottom-color: black; border-top-color: black; border-right-width: thin; border-right-color: black;"
                                    Width="100%">
                                </asp:Table>
            ...
            <tr>
                <td colspan="4">
                    <asp:Image ID="Image3" runat="server" Height="4px" ImageUrl="~/GifImages/myline1.jpg" Width="588px" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-weight: bold; color: black;" colspan="4">
                    ...
                    <asp:Label ID="netsalword" runat="server" style="font-size: 10pt"></asp:Label></td>
            </tr>
            <tr>
                <td colspan="4" style="font-weight: bold; color: black">
                     <asp:Image ID="Image5" runat="server" Height="4px" ImageUrl="~/GifImages/myline1.jpg" Width="588px" /></td>
            </tr>
        </table>
