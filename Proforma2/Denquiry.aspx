<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="Denquiry.aspx.cs" Inherits="NewWebApp.Proforma2.Denquiry" %>
                ...
                <tr>
                    <td colspan="2" style="font-weight: bold; font-size: 14px; width: 100%; color: #661700;
                        ...
                        Dept. Proceedings Type</td>
                                    <td align="left" style="width: 25%; height: 25px;">
                        <asp:DropDownList class="form-control" ID="DET" runat="server" Width="160px" OnSelectedIndexChanged="DET_SelectedIndexChanged">
                            ...
                            <asp:ListItem>Disciplinary</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 25%; height: 25px; background-color: #fffbd6;">
                        <asp:DropDownList class="form-control" ID="DES" runat="server" Width="160px" AutoPostBack="True" OnSelectedIndexChanged="DES_SelectedIndexChanged">
                            <asp:ListItem>--select--</asp:ListItem>
                        ...
                        <asp:Label ID="Eqr" runat="server" Text="Proceedings Result" Width="144px"></asp:Label>
                                    ...
                                    <td align="left" style="width: 25%;">
                        <asp:TextBox class="form-control" ID="EResult" runat="server" Width="160px"></asp:TextBox></td>
                                    <td align="left" style="width: 25%;">
                        <asp:Label ID="maxid" runat="server" Visible="False"></asp:Label></td>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 25%; height: 25px; background-color: #fffbd6;">
                        <asp:Button class="btn btn-success" ID="SAVE" runat="server" Text="Save" OnClick="SAVE_Click" /></td>
                                    <td align="left" style="width: 25%; height: 25px; background-color: #fffbd6;">
                                    <asp:Button class="btn btn-default" ID="FSheet" runat="server" OnClick="FSheet_Click" Text="Fact Sheet"
                ...
                <tr>
                    <td colspan="2" style="font-size: 12px; color: #ffffff; text-align: left">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:uphsdpConnectionString %>"
                            SelectCommand="SELECT enqid, enqtype, enqstatus FROM Enquiry WHERE (idno = @idno)" DeleteCommand="delete from Enquiry WHERE (enqid = @enqid)">
                            <SelectParameters>
