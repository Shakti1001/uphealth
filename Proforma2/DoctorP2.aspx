<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorP2.aspx.cs" Inherits="NewWebApp.Proforma2.DoctorP2" %>
                        ...
                        <tr>
                            ...
                            <td rowspan="3">
                                <asp:Image ID="Image1" runat="server" BorderColor="Navy" BorderStyle="Solid" BorderWidth="2px"
                                    Height="80px" ImageAlign="Top" Width="80px" /></td>
                        </tr>
                        <tr>
