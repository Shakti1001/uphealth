<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="joinorderprint.aspx.cs" Inherits="NewWebApp.Proforma2.joinorderprint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Joining Order...</title>
                            ...
                            <table style="width: 700px; height: 85px; font-family: Times New Roman; left: -6px; position: relative; top: 0px;">
                                ...
                                <tr>
                                    <td style="width: 100%; height: 5%">
                                        <span><strong><span>
                                            ...
                                            <span style="text-decoration: underline">कार्यभार प्रमाण पत्र<span style="text-decoration: underline"></span></span></span></strong><strong><span style="text-decoration: underline"></span></strong></span></td>
                                </tr>
                                ...
                                <tr>
                                    <td style="width: 100%; height: 50%; text-align: left;" valign="top">
                                        ...
                                        &nbsp;का 
                                        कार्यभार
                                        <asp:Label ID="orderbyt" runat="server" Font-Bold="True"></asp:Label>&nbsp; ,&nbsp;उत्तर प्रदेश के &nbsp; &nbsp; आदेश संख्या &nbsp;
                                                ...
                                                <tr>
                                                    <td style="width: 50%; height: 10%; text-align: left" valign="top">
                                                        <span>अवमोचक अधिकारी<br />
                                                            ...
                                                            <br />
                                                            हस्ताक्षर<br />
                                                            (<asp:Label ID="Joinname" runat="server" Font-Bold="True"></asp:Label>)</span></td>
                                                    <td style="width: 50%; height: 10%; text-align: right" valign="top">
                                                        ...
                                                        <br />
                                                        हस्ताक्षर<br />
                                                        <asp:Label ID="replacername" runat="server" Font-Bold="True"></asp:Label></td>
                                                </tr>
                                                <tr>
                                        ...
                                        प्रतिहस्ताक्षरित<br />
                                                ...
                                                <tr>
                                                    <td colspan="2" style="height: 100%; text-align: left" valign="top">
                                                        <br />
                                                        प्रतिलिपि :निम्न लिखित को सूचनार्थ एवम आवश्यक कार्यवाही हेतु प्रेषित।<br />
                                                        <br />
                                                        ...
                                                        <br />
                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 4. कोषाधिकारी,
                                                        <asp:Label ID="PLACE" runat="server" Font-Bold="True"></asp:Label>
                                                        ।<br />
                                                        <br />
