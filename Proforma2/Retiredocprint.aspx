<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Retiredocprint.aspx.cs" Inherits="NewWebApp.Proforma2.Retiredocprint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Retire Doctors</title>
</head>
                ...
                <tr>
                    <td colspan="4" style=" width: 896px; color: #000000; background-color: #cccccc; text-align: center; font-weight: bold; font-size: 14px;">
                        <span style="font-size: 12pt; font-family: 'Times New Roman'; mso-fareast-font-family: 'Times New Roman';
                            ...
                            mso-bidi-language: AR-SA"> Doctors Are Going To
                        Retire</span>&nbsp;<asp:Label ID="Uidt" runat="server"
