<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="EditJR.aspx.cs" Inherits="NewWebApp.Proforma2.EditJR" %>
            ...
            <td colspan="2" style="font-weight: bold; font-size: 14px; width: 100%; color: maroon;
                ...
                <asp:TextBox ID="JRText" runat="server"></asp:TextBox></td>
                    ...
                    ValidationExpression="^([0]?[1-9]|[1][0-2])[./-]([0]?[1-9]|[1|2][0-9]|[3][0|1])[./-]([0-9]{4}|[0-9]{2})$"></asp:RegularExpressionValidator>
                            ...
                            <td align="left" style="width: 25%">
                                <asp:Label ID="idnoL" runat="server" Visible="False" ForeColor="#661700"></asp:Label><asp:Label ID="curdate" runat="server" ForeColor="#661700" Visible="False"></asp:Label><asp:Label ID="oid" runat="server" ForeColor="#661700" Visible="False"></asp:Label>
                                <asp:Label ID="sno" runat="server" ForeColor="#661700" Visible="False"></asp:Label></td>
                        </tr>
                        <tr>
                            <td align="left" style="width: 25%; background-color: #fff8dc; height: 24px;">
                            </td>
                            <td align="left" style="width: 25%; background-color: #fff8dc; height: 24px;">
                            </td>
                            <td align="left" style="width: 25%; background-color: #fff8dc; height: 24px;">
                    <asp:Button class="btn btn-success" ID="BSAVE" runat="server" Text="Update Order" OnClick="BSAVE_Click" Width="105px" /></td>
                            <td align="left" style="width: 25%; background-color: #fff8dc; height: 24px;">
