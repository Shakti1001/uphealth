<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="senioritylistprint.aspx.cs" Inherits="NewWebApp.Proforma2.senioritylistprint" %>
...
<body leftmargin="0px" topmargin="0px" style="text-align: center">
    ...
    <div align="center">
        <div style="text-align: center" align="center">
            ...
            <table 
                style="font-weight: normal; left: -6px; width: 800px; font-family: Arial; position: relative;
                top: 0px; height: 88px; border-right: #000033 thin solid; border-top: #000033 thin solid; border-left: #000033 thin solid; border-bottom: #000033 thin solid; color: #330000;" 
                ...
                <tr>
                    <td colspan="4" style=" width: 896px; color: #000000; background-color: #cccccc; text-align: center; font-weight: bold; font-size: 14px; height: 24px;">
                        Seniority List &nbsp;&nbsp;<asp:Label ID="Uidt" runat="server"
