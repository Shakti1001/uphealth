<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="specialization.aspx.cs" Inherits="NewWebApp.Proforma2.specialization" %>
...
<div class="container" style="text-align: center">
                                    ...
                                    <table style="table-layout:fixed;" class="table table-responsive-sm" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td bgcolor="#fe8631" class="normalEng" height="34" style="font-weight: bold; color: #ffff99;
                                                ...
                                                Medical Section / P2 / Factsheet Search On Specialization
        ...
        <asp:Label ID="count" runat="server" Visible="False"></asp:Label><asp:Label
            ID="Divs" runat="server" Visible="False">%</asp:Label><asp:Label ID="Uidt" runat="server" Visible="False"></asp:Label><asp:Label ID="Ename" runat="server" Visible="False"></asp:Label></td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; table-layout:fixed; height: 100%; font-weight: bold; color: maroon;">
                            <tr>
                                ...
                                <td align="left" style="width: 25%; height: 25px">
                                    Name</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:TextBox class="form-control" ID="name" runat="server" AutoPostBack="True" ></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    Fathers Name</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:TextBox class="form-control" ID="fname" runat="server" AutoPostBack="True" ></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                             <tr>
                    ...
                    Seniority No.</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:TextBox class="form-control" ID="Sen" runat="server" AutoPostBack="True" ></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                    ...
                    Cadre</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:DropDownList class="form-control" ID="DCadre" runat="server" Width="90%" AutoPostBack="True" >
                </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    <asp:Label ID="DL" runat="server" Text="Division"></asp:Label></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:DropDownList ID="DDiv" class="form-control" runat="server" AutoPostBack="True" 
                        Width="90%">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                                </td>
                    ...
                    District</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:DropDownList class="form-control" ID="DDistrict" runat="server" AutoPostBack="True" Width="90%" >
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    Hospital Name</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:DropDownList class="form-control" ID="DHname" runat="server" Width="90%" AutoPostBack="True" >
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                    ...
                    Designation</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:DropDownList class="form-control" ID="DDesign" runat="server" Width="90%" AutoPostBack="True" >
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    Post</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:DropDownList class="form-control" ID="Dpost" runat="server" Width="90%" >
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="left" style="width: 25%; height: 25px;">
                    <asp:Button class="btn btn-default" ID="Refresh" runat="server"  Text="Refresh" Visible="False" /></td>
                                <td align="left" style="width: 25%; height: 25px;">
                    Level</td>
                                <td align="left" style="width: 25%; height: 25px;">
                    <asp:DropDownList class="form-control" ID="Dlevel" runat="server" Width="90%" AutoPostBack="True" >
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px;">
                                </td>
                            </tr>
                    ...
                    <asp:Button class="btn btn-success" ID="Submit" runat="server" Text="Submit" /></td>
                            </tr>
                        </table>
