<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="Qualedit.aspx.cs" Inherits="NewWebApp.Proforma2.Qualedit" %>
        ...
        <table class="table table-responsive-sm" style="font-weight: bold; width: 100%; color: #3366cc;
            ...
            <tr>
                ...
                <asp:Label ID="Msg" runat="server" Text="Label" Visible="False" ForeColor="#C00000"></asp:Label></td>
                                <td align="left" style="width: 25%; height: 25px;">
                    <asp:Button ID="save" class="btn btn-success" runat="server" OnClick="save_Click" Text="Save" /></td>
                                <td align="left" style="width: 25%; height: 25px;">
                                </td>
                            </tr>
                        </table>
            ...
            <tr>
                <td colspan="2" style="width: 100%; text-align: left; font-size: 12px;" valign="top">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:uphsdpConnectionString %>"
                        DeleteCommand="delete from qual_det  WHERE (qid_serial = @qid_serial)" SelectCommand="SELECT qual_det.qid_serial, specialization.spname, Qualification.QuaName FROM qual_det INNER JOIN Qualification ON qual_det.qid = Qualification.QuaId INNER JOIN specialization ON qual_det.sid = specialization.spid WHERE (qual_det.idno = @idno) ORDER BY Qualification.QuaName">
                        <DeleteParameters>
