<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proforma1print.aspx.cs" Inherits="NewWebApp.TransferSec.proforma1print" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Allopathic Doctor Factsheet</title>
</head>
<body leftmargin="0px" topmargin="0px" style="text-align: center">
    ...
    <div>
        <div style="text-align: center">
            ...
            <table style="font-weight: normal; left: -6px; width: 700px; font-family: Arial; position: relative;
