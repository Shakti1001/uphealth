<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="TransferList.aspx.cs" Inherits="NewWebApp.TransferSec.TransferList" %>
                ...
                <div style="text-align: center">
                    ...
                    Order No:</td>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 25%; background-color: #fff8dc">
                    <asp:Button class="btn btn-success" ID="BSAVE" runat="server" Text="No Compliance List" OnClick="BSAVE_Click" Width="140px" /></td>
                        </tr>
                         <tr>
                            <td align="left" style="width: 25%; text-align: right;">
                                <asp:Label ID="Label1" runat="server" Text="Transfer Order Date:" Visible="False"></asp:Label></td>
                            <td align="left" style="width: 25%"><asp:DropDownList ID="TrDateDD" runat="server" Width="80%" AutoPostBack="True" Visible="False" >
                            </asp:DropDownList></td>
