<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="namesearch.aspx.cs" Inherits="NewWebApp.TransferSec.namesearch" %>
...
<div class="container" style="text-align: center">
        <div style="text-align: center">
            ...
            <table class="table table-responsive-sm" style="width: 100%; border-top-width: thin; border-left-width: thin; border-left-color: #990000; border-bottom-width: thin; border-bottom-color: #990000; color: #003366; border-top-color: #990000; font-family: Georgia; border-right-width: thin; border-right-color: #990000;" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="font-weight: bold; width: 100%; color: #ffff99; background-color: #661700; height: 25px; text-align: left;">
                        &nbsp; Medical Section/ Relieving/Joining/<a id="ctl00_ContentPlaceHolder1_RetLink" href="javascript:__doPostBack('ctl00$ContentPlaceHolder1$RetLink','')"
                            style="font-weight: bold; color: #ffff99">Retierment Section</a> (Click On First
                        Letter Of Name)
                ...
                <tr>
                    <td style="background-image: url(../../images/tab.jpg); width: 100%; color: #003366;
                        ...
                        <asp:Table class="table table-responsive-sm" ID="Table1" runat="server" Height="100%" Width="100%" CellPadding="0" CellSpacing="0">
                        </asp:Table>
                        </td>
                </tr>
                <tr>
                    <td style="font-size: 12px; width: 100%; color: #661700; font-family: Arial; background-color: #661700;
                        ...
                        <asp:Label ID="mesg" runat="server" Font-Bold="True" ForeColor="White"></asp:Label>.</td>
                </tr>
            </table>
        </td>
                </tr>
