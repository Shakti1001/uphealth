<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="TRmenu.aspx.cs" Inherits="NewWebApp.TransferSec.TRmenu" %>
            ...
            <table class="table table-responsive-sm table-active" style="width: 100%">
                ...
                <tr>
                    <td colspan="2" style="width: 100%; text-align: center" valign="top">
                                                ...
                                                <table class="table table-responsive-sm" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td bgcolor="#fe8631" class="normalEng" height="34" style="font-weight: bold; color: #ffff99;
                                                            ...
                                                            &nbsp; Medical Section / Transfer Option
                        ...
                        <asp:LinkButton ID="TransferOrLink" runat="server" Font-Bold="True" OnClick="TransferOrLink_Click" ForeColor="#74211F">Add Transfer Order </asp:LinkButton></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                        <asp:LinkButton ID="TransferLink" runat="server" Font-Bold="True" OnClick="TransferLink_Click" ForeColor="#74211F">Select Individual  Transfered</asp:LinkButton></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                        <asp:LinkButton ID="rellink" runat="server" Font-Bold="True" OnClick="rellink_Click" ForeColor="#74211F">Non Compliance  Transfer Report</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#376fbc" height="30" style="font-weight: bold; background-color: #fff8dc">
                                                            &nbsp;</td>
                                                        <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                                                            <asp:LinkButton ID="SOtr" runat="server" Font-Bold="True" ForeColor="#74211F"
                                                                OnClick="SOtr_Click">Transfer Order Compliance Status  </asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10">
                                                        </td>
