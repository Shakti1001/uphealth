<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Title.ascx.cs" Inherits="Admin_Title" %>
<div style="text-align: center">
    <table style="width: 960px">
        <tr>
            <td style="background-image: url(../images/title.jpg); width: 960px; height: 37px;
                text-align: right; font-weight: bold; color: #ffffff; font-family: Arial;">
...
//-->
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" ForeColor="OrangeRed"
