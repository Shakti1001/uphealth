<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pmdbankstate.aspx.cs" Inherits="NewWebApp.pmdpayrole.pmdbankstate" %>
            ...
            <tr>
                <td align="center" height="57" valign="top" width="100%" style="background-color: #660000">
                    <table id="table10" align="center" bgcolor="#00ccff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <td bgcolor="#ffffff" colspan="2" style="height: 0px">
                                <div align="center" class="normal style3">
                                    ...
                                    <p class="style4" style="font-weight: bold; font-size: 14pt; color: navy; background-color: #ffffcc">
                                        Bank Statement made from salary for the month 
                                        ...
                                        <span class="style5"><strong><span style="font-size: 9pt"><span style="font-family: Arial; font-size: 12pt; background-color: #ffffcc;">
                        ...
                        <tr>
                            <td bgcolor="#ffffff" colspan="2" style="text-align: center; background-color: #ffffcc; height: 14px;">
                                ...
                                <asp:Table ID="Table1" runat="server" CellPadding="0" CellSpacing="0" Width="90%" style="left: -9px; position: relative; top: -64px; background-color: #e8cd76; text-align: center" HorizontalAlign="Center">
                                </asp:Table>
                        ...
                        <tr>
                            <td bgcolor="#ffffff" colspan="2" height="38" style="background-color: #660000">
                                <asp:Label ID="MSGLab" runat="server" style="font-size: 11pt; color: white" Font-Bold="True" ForeColor="Yellow"></asp:Label></td>
                        </tr>
                    </table>
                </td>
            </tr>
