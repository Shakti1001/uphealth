<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vehschinst.aspx.cs" Inherits="NewWebApp.pmdpayrole.vehschinst" %>
                            ...
                            <td bgcolor="#ffffff" colspan="2" style="height: 0px">
                                <div align="center" class="normal style3">
                                    ...
                                    <p class="style4" style="font-weight: bold; font-size: 14pt; color: navy; background-color: #ffffcc">
                                        Schedule Of Vehicle 
                                        Interest Advance made from salary for the month 
                                        ...
                                        payable on 1st of next month<br />   <span class="style5"><strong><span style="font-size: 9pt"><span style="font-family: Arial; font-size: 12pt; background-color: #ffffcc;">
                                            ...
                                            style="font-size: 11pt">004904800030300</asp:Label>
