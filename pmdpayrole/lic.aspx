<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lic.aspx.cs" Inherits="NewWebApp.pmdpayrole.lic" %>
                    ...
                    <table id="table10" align="center" bgcolor="#00ccff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <td bgcolor="#ffffff" colspan="2" style="height: 0px">
                                <div align="center" class="normal style3">
                                    ...
                                    <p class="style4" style="font-weight: bold; font-size: 14pt; color: navy; background-color: #ffffcc">
                                        Schedule Of Lic made from salary for the month 
                        ...
                        <tr>
                            <td bgcolor="#ffffff" colspan="2" style="text-align: left; background-color: #ffffcc; height: 14px;">
                                ...
                                </asp:Table><asp:Table ID="Table1" runat="server" CellPadding="0" 
                                    CellSpacing="0" Width="90%" 
                                    style="left: 41px; position: relative; top: -57px; background-color: #e8cd76; ">
                                </asp:Table>
                                <div class="style1">
                                <asp:Table ID="Table3" runat="server" CellPadding="0" CellSpacing="0" Width="100%" 
                                        style="left: 0px; position: relative; top: -113px; background-color: #e8cd76; ">
                                </asp:Table>
                                </div>
                            </td>
                        </tr>
