<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="ChangeUpass.aspx.cs" Inherits="NewWebApp.pmdpayrole.ChangeUpass" %>
            ...
            <table class="table table-responsive-sm table-active" style="  width: 100%; font-weight: bold; color: #661700;">
                <tr>
                    <td style="width: 100%; text-align: right;" valign="top" colspan="2">
                        <asp:LinkButton class="btn btn-danger" ID="LinkButton1" runat="server" PostBackUrl="javascript:history.go(-1)"><span class="glyphicon glyphicon-backward"></span>Back</asp:LinkButton>
                        &nbsp;
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="width: 100%; text-align: center" valign="top">
                        <div style="text-align: center">
                            <table class="table table-responsive-sm" style="width: 100%; height: 100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td colspan="3">
        <table class="table table-responsive-sm" style="font-weight: bold; width: 100%; color: #661700; font-family: Georgia; height: 100%; border-right: #333333 thin solid; border-top: #333333 thin solid; border-left: #333333 thin solid; border-bottom: #333333 thin solid; background-color: #fffbd6;">
                <tr>
            ...
            <tr>
                <td style="width: 100%; text-align: center;">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp;
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Change Password" Width="144px" /></td>
            </tr>
            </table>
                                    </td>
                                </tr>
