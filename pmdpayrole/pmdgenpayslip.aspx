<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="pmdgenpayslip.aspx.cs" Inherits="NewWebApp.pmdpayrole.pmdgenpayslip" %>
...
<div class="container" style="text-align: center">
    <%--SERVICE BOOK :::: Personal Management System--%>
       <table class="table table-responsive-sm table-active" style="width: 100%; background-color: #e8cd76; color: white;">
            <tr>
                <td style="width: 100%; text-align: center; height: 11px; background-color: #e8cd76; position: relative; font-weight: bold; color: maroon; top: 2px; left: 2px;">
                     <tr>
                    ...
                    <br />
                                                ...
                                                <asp:Label ID="Lblmon" runat="server" Text="Month/Year" style="font-weight: bold; color: navy" ForeColor="Maroon"></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" style="text-align: center">
                                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Submit" ValidationGroup="group1" /></td>
                                                    </tr>
                                                    <tr>
