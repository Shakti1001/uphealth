<%@ Page Title="::Add Salary::" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="pmdpayroleselect.aspx.cs" Inherits="NewWebApp.pmdpayrole.pmdpayroleselect" %>
            ...
            <table class="table table-responsive-sm table-active" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <tr>
                    <td style="width: 100%" valign="top">
                        <table class="table table-responsive-sm" cellpadding="0" cellspacing="0" style="border-top-width: thin; border-left-width: thin;
                            border-left-color: #990000; border-bottom-width: thin; border-bottom-color: #990000;
                            width: 100%; color: #003366; border-top-color: #990000; font-family: Georgia;
                            border-right-width: thin; border-right-color: #990000">
                            <tr>
                                <td style="font-weight: bold; width: 100%; color: #ffff99; height: 25px; background-color: #661700;
                                    text-align: left">
                                                &nbsp; ParaMedical Section / Payroll / Enrty (Click On First Letter Of Name)
                            ...
                            <tr>
                                <td style="width: 100%; height: 25px; background-color: #fffbd6">
                                    ...
                                    <asp:Label ID="Ctot" runat="server" ForeColor="#C00000"></asp:Label>
                            ...
                            <tr>
                                <td style="font-size: 12px; background-image: url(../../images/tab.jpg); width: 100%;
                                    color: #003366; font-family: Arial; text-align: left">
                            ...
                            <tr>
                                <td style="font-size: 12px; width: 100%; color: #661700; font-family: Arial; height: 25px;
                                    background-color: #661700; text-align: center">
                                    <asp:Label ID="mesl" runat="server" Font-Bold="True" ForeColor="White"></asp:Label>.</td>
                            </tr>
                        </table>
                    </td>
                </tr>
