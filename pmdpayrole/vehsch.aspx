<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vehsch.aspx.cs" Inherits="NewWebApp.pmdpayrole.vehsch" %>
            ...
            <tr>
                <td align="center" height="57" valign="top" width="100%" style="background-color: #660000">
                    <table id="table10" align="center" bgcolor="#00ccff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <td bgcolor="#ffffff" colspan="2" style="height: 0px">
                                <div align="center" class="normal style3">
                                    ...
                                    <p class="style4" style="font-weight: bold; font-size: 14pt; color: navy; background-color: #ffffcc">
                                        Schedule Of Vehicle Advance made from salary for the month 
                                        <asp:Label ID="MonthLabel" runat="server"></asp:Label><asp:Label ID="YearLabel" runat="server"></asp:Label>of
                                        
                                        payable on 1st of next month<br />   <span class="style5"><strong><span style="font-size: 9pt"><span style="font-family: Arial; font-size: 12pt; background-color: #ffffcc;">
                                            &nbsp;Head Of Account:-<asp:Label ID="Headlbl" runat="server" 
                                            style="font-size: 11pt">761000203000000</asp:Label>
                        ...
                        <tr>
                            <td colspan="2" style="background-color: #ffffcc; height: 77px;">
                                </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td bgcolor="#ffffff" colspan="2" height="38" style="background-color: #660000">
                                <strong>
                                <asp:Label ID="MSGLab" runat="server" Text="" style="color: white" 
                                    CssClass="style1"></asp:Label></strong></td>
                        </tr>
                    </table>
                </td>
            </tr>
