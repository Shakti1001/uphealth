<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HBASchinst.aspx.cs" Inherits="NewWebApp.pmdpayrole.HBASchinst" %>
                            ...
                            <td bgcolor="#ffffff" colspan="2" style="height: 0px">
                                <div align="center" class="normal style3">
                                    ...
                                    <p class="style4" style="font-weight: bold; font-size: 14pt; color: navy; background-color: #ffffcc">
                                        Schedule Of HBA 
                                        Interest made from salary for the month 
                                        ...
                                        &nbsp;Head Of Account:-<asp:Label ID="Headlbl" runat="server" 
                                            style="font-size: 11pt">004904800030100</asp:Label>
