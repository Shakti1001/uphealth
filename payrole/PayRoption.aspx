<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="PayRoption.aspx.cs" Inherits="NewWebApp.payrole.PayRoption" %>
                                    ...
                                    <td colspan="2" style="width: 100%; height: 25px; text-align: center">
                                        <table class="table table-responsive-sm" border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%">
                                                    &nbsp;<asp:DropDownList ID="year" runat="server" Width="51%" AutoPostBack="True">
                                        </asp:DropDownList></td>
                                                <td style="width: 25%">
                                                </td>
                                            </tr>
                                        ...
                                        &nbsp;Month &nbsp;
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%; height: 15px; font-weight: bold; color: maroon; text-align: center; font-size: 13pt;">
                                                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;GPF/New Pension Series</td>
                                                <td style="width: 25%; height: 15px;">
                                                    &nbsp;<asp:DropDownList ID="gpfseries" runat="server" Width="90%">
                                                        <asp:ListItem Value="0">ALL</asp:ListItem>
                                                        <asp:ListItem Value="1">MEDU </asp:ListItem>
                                                        <asp:ListItem Value="2">PHU</asp:ListItem>
                                                        <asp:ListItem Value="3">PRAN ALL</asp:ListItem>
                                                        <asp:ListItem Value="4">GPF ALL</asp:ListItem>
                                                        <asp:ListItem Value="5">PU</asp:ListItem>
                                                        <asp:ListItem Value="6">JU</asp:ListItem>
                                                    </asp:DropDownList></td>
                                                <td style="width: 25%; height: 15px;">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%; background-color: burlywood">
                                        <asp:Button ID="save" class="btn btn-success" runat="server" OnClick="save_Click" Text="Submit" Font-Bold="True" ForeColor="#C00000" /></td>
                                                <td style="width: 25%; background-color: burlywood">
                                        </td>
                                            </tr>
                                        </table>
