<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paygpfshedule.aspx.cs" Inherits="NewWebApp.payrole.paygpfshedule" %>
                            ...
                            <td bgcolor="#ffffff" colspan="2" style="height: 0px">
                                <div align="center" class="normal style3">
                                    ...
                                    <p class="style4" style="font-weight: bold; font-size: 14pt; color: navy; background-color: #ffffcc">
                                        Schedule Of GPF made from salary for the month 
                                        ...
                                        <span class="style5"><strong><span style="font-size: 9pt"><span style="font-family: Arial; font-size: 12pt; background-color: #ffffcc;">
                                            ...
                                            <asp:Label ID="Label2" runat="server" Text="8009-01-110-02"></asp:Label></span></span></strong></span></p>
                                </div>
                            </td>
                        </tr>
                        <tr>
