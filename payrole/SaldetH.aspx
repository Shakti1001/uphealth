<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="SaldetH.aspx.cs" Inherits="NewWebApp.payrole.SaldetH" %>
                            ...
                            <table class="table table-responsive-sm" border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 404px">
                                <tr>
                                    ...
                                    <td bgcolor="#fe8631" class="normalEng" height="34" style="font-weight: bold; color: #ffff99;
                                        ...
                                        &nbsp; Medical Section / Payroll &nbsp;<asp:Label ID="Fnamet" runat="server" Visible="False"></asp:Label></td>
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                                        <asp:LinkButton ID="LADD" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#74211F"
                                            OnClick="LADD_Click" Width="184px">Add /Edit Loan Entry</asp:LinkButton></td>
                                </tr>
                                <tr>
                                    <td style="height: 10px">
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                                        <asp:LinkButton ID="statuslink" runat="server" Font-Bold="True" Font-Size="Medium"
                                            ForeColor="#74211F" OnClick="statusrep_Click" Width="269px">Status Of Pay Records Data Entry</asp:LinkButton></td>
                                </tr>
                                 <tr>
                                    <td style="height: 10px">
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td bgcolor="#376fbc" colspan="3" height="30" style="background-color: #fff8dc; text-align: left">
                                        ...
                                        &nbsp; &nbsp; &nbsp;&nbsp;<asp:Label ID="Label6" runat="server" Font-Bold="True"
                                            ForeColor="#C00000" Text="Use to Apply  For All Doctor's at a Time"></asp:Label>&nbsp;&nbsp;
