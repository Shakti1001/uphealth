<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="Proformachoice.aspx.cs" Inherits="NewWebApp.payrole.Proformachoice" %>
            ...
            ID="Divs" runat="server" Visible="False">%</asp:Label><asp:Label ID="Uidt" runat="server" Visible="False"></asp:Label><asp:Label ID="Ename" runat="server" Visible="False"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="#376fbc" colspan="4" height="30" style="background-color: #fff8dc">
                                                <table style="border-top-width: thin; border-left-width: thin; border-left-color: #990000;
                    ...
                    District</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:DropDownList ID="DDistrict" runat="server" AutoPostBack="True" Width="90%" OnSelectedIndexChanged="DDistrict_SelectedIndexChanged">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    Hospital Name</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:DropDownList ID="DHname" runat="server" Width="90%" AutoPostBack="True" OnSelectedIndexChanged="DHname_SelectedIndexChanged">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                    ...
                    Computer No.</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:TextBox ID="cmpuno" runat="server"></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                            <tr>
                    ...
                    Seniority No.</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:TextBox ID="Sen" runat="server" AutoPostBack="True" OnTextChanged="Sen_TextChanged"></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" style="width: 25%; height: 25px">
                                    Name</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:TextBox ID="name" runat="server" AutoPostBack="True" OnTextChanged="name_TextChanged"></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                            <tr>
                    ...
                    Fathers Name</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:TextBox ID="fname" runat="server" AutoPostBack="True" OnTextChanged="fname_TextChanged"></asp:TextBox></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                            <tr>
                    ...
                    Designation</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:DropDownList ID="DDesign" runat="server" Width="90%" AutoPostBack="True" OnSelectedIndexChanged="DDesign_SelectedIndexChanged">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    Post</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:DropDownList ID="Dpost" runat="server" Width="90%" OnSelectedIndexChanged="Dpost_SelectedIndexChanged">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                    ...
                    Cadre</td>
                                <td align="left" style="width: 25%; height: 25px">
                    <asp:DropDownList ID="DCadre" runat="server" Width="90%" AutoPostBack="True" OnSelectedIndexChanged="DCadre_SelectedIndexChanged">
                </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px">
                                </td>
                            </tr>
                    ...
                    Level</td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                    <asp:DropDownList ID="Dlevel" runat="server" Width="90%" AutoPostBack="True" OnSelectedIndexChanged="Dlevel_SelectedIndexChanged">
                    </asp:DropDownList></td>
                                <td align="left" style="width: 25%; height: 25px; background-color: #fff8dc">
                                </td>
                            </tr>
                ...
                <asp:Label ID="strq" runat="server" Font-Size="Small" Visible="False" ForeColor="Red"></asp:Label></td>
                                                    ...
                                                    <tr>
                                                        <td style="font-size: 11px; background-image: url(../images/tab.jpg); width: 100%;
                                                            ...
                                                            <asp:Table ID="Table1" runat="server" CellPadding="1" CellSpacing="1" Font-Bold="True"
