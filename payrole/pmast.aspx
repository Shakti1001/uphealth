<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="pmast.aspx.cs" Inherits="NewWebApp.payrole.pmast" %>
                            ...
                            <table class="table table-responsive-sm" style="width: 100%; background-color: #fff8dc; font-weight: bold; font-size: 14px; color: maroon; text-align: left;">
                                ...
                                <tr>
                                    <td style="width: 16%">
                                        &nbsp;PAN No.&nbsp;</td>
                                    <td style="width: 16%">
                                        <asp:TextBox ID="PAN" runat="server"></asp:TextBox></td>
                                    <td style="width: 16%">
                                        Bank Name</td>
                                    <td style="width: 16%">
                                ...
                                <tr>
                                    <td style="width: 16%; height: 21px">
                                        Remark</td>
                                    <td style="width: 16%; height: 21px">
                                        <asp:TextBox ID="RMARKT" runat="server"  Width="94%"></asp:TextBox></td>
                                    <td style="width: 16%; height: 21px">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 16%; height: 21px">
                                        NPA</td>
                                    <td style="width: 16%; height: 21px">
                                        <asp:TextBox ID="GradePay" runat="server"></asp:TextBox></td>
                                    <td style="width: 16%; height: 21px">
                                        H.R.A.</td>
                                    <td style="width: 16%; height: 21px">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 16%; height: 21px">
                                        <asp:TextBox ID="AttText" runat="server" Width="94%" Visible="False"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 16%; height: 21px">
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 16%; height: 21px">
                                        <asp:TextBox ID="elecbill" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 16%; height: 21px">
                                        OtherSalaryDeduction</td>
                                    <td style="width: 16%; height: 21px">
                                        <asp:TextBox ID="SDT" runat="server"></asp:TextBox></td>
                                    <td style="width: 16%; height: 21px">
                                        House Rent Recovery</td>
                                    <td style="width: 16%; height: 21px">
                                        <asp:TextBox ID="HRR" runat="server"></asp:TextBox></td>
                                    <td style="width: 16%; height: 21px">
                                        Recurring Deposit</td>
                                    <td style="width: 16%; height: 21px">
                                        <asp:TextBox ID="RD" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 16%; height: 21px">
                                    </td>
