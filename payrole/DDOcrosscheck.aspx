<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="DDOcrosscheck.aspx.cs" Inherits="NewWebApp.payrole.DDOcrosscheck" %>
                    ...
                    <tr>
                        <td style="width: 100%; text-align: right">
                            <asp:LinkButton class="btn btn-danger" ID="LinkButton1" runat="server" 
                                onclick="LinkButton1_Click"><span classs="glyphicon glyphicon-backward"></span>Back</asp:LinkButton> </td>
                    </tr>
                    <tr>
