<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/admin.Master" AutoEventWireup="true" CodeBehind="Loanedit.aspx.cs" Inherits="NewWebApp.payrole.Loanedit" %>
                        ...
                        <table class="table table-responsive-sm" cellpadding="0" cellspacing="0" style="border-top-width: thin; border-left-width: thin;
                            ...
                            <tr>
                                <td style="font-weight: bold; width: 100%; color: #ffff99; height: 25px; background-color: #661700;
                                    text-align: left">
                                                &nbsp; Medical Section / Payroll / Edit Enrty (Click On First Letter Of Name)
